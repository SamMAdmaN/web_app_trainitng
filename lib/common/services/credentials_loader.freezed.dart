...
abstract class $CredentialsCopyWith<$Res> {
  ...
  @useResult
  $Res call({String appName, String apiBaseUrl, String appId});
}
...
class _$_Credentials implements _Credentials {
  const _$_Credentials(
      {required this.appName, required this.apiBaseUrl, required this.appId});
  ...
  @override
  String toString() {
    return 'Credentials(appName: $appName, apiBaseUrl: $apiBaseUrl, appId: $appId)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, appName, apiBaseUrl, appId);
...
abstract class _Credentials implements Credentials {
  const factory _Credentials(
      ...
      required final String appId}) = _$_Credentials;
